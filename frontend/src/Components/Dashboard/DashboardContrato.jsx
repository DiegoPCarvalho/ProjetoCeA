            ...
            <Main {...headerProps}>
                <div className='master'>
                    ...
                    <div className='d-flex '>
                        ...
                        {this.CardTotalIMpressoras('TC51','success','',50,'Finalizada')}
                        </div>
                        <div className='text-light mx-1 sombra'>
                            {this.CardTotalIMpressoras('TC56','success','',50,'Finalizada')}
                        </div>
                    </div>
                    ...
                    <div className='d-flex text-light'>
                        <div className='mx-1 sombra'>{this.CardTotalIMpressoras('Aguardando Chegar','warning','',50)}</div>
